define(['config', 'IM', 'game', 'canvas', 'utils', 'input', 'stars'], function(config, IM, game, canvas, utils, input, stars) {
	...
	function Menu()
	{
		...
		**/
		...
		this.render = function()
		{
			...
			canvas.ctx.fillText('LEAP WARS', canvas.canvas.width * .5, canvas.canvas.height * .5);
			canvas.ctx.font = '56pt silkscreennormal';
			canvas.ctx.fillText('Swipe anywhere to start game', canvas.canvas.width * .5, canvas.canvas.height * .5 + 72);
